...
#*SOURCE FILES *#
PARSING = tokeniser.c evar.c string_handler_tools.c env.c split_quotes.c quotes.c spaces_tools.c strings_tools.c strings_tools_2.c minishell.c parser.c utils.c utils_2.c utils_3.c init_nodes.c  
